...
public class SpeechBubbleLineView : DialogueViewBase
{
    ...
    System.Collections.Generic.Dictionary<string, GameObject> speakers = new();
    ...
    public override void RunLine(LocalizedLine dialogueLine, Action onDialogueLineFinished)
    {
        ...
        string characterLine = splitText[1];
        text.text = characterLine;

        if (!speakers.ContainsKey(characterName))
        {
            characterSpeaking = GameObject.Find(characterName);
